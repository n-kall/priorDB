...
distributions. Alternatively, hurdle models are useful when the process generating the zero counts is conceptually different from the one generating the positive counts.